...
<div class="content-wrapper">
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <form role="form" method="POST" action="{{ url('adminfimihub/addAboutUs')}}" id="personal-info"
                            ...
                            <div class="form-footer">
                                <input type="submit" class="btn btn-primary" value="Save About Us"></input>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i> About Us List</div>
                    <div class="card-body">
