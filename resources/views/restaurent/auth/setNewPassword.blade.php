    ...
    <div
        ...
        <div class="card-body">
            <div class="card-content p-2">
                ...
                <form role="form" method="POST" action="{{ url('/Restaurent/verifyForgetPasswordOtp') }}">
                    @csrf
                    ...
                    <div class="form-row mr-0 ml-0">
                        ...
                        <div class="form-group col-6 text-right">
                            <a href="{{url('Restaurent/resendNewOtp')}}" class="resend_link">Resend OTP</a>
                            <span class="timer">0:00</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <input type="text" class="form-control form-control-rounded" id="input-1" name="password"  placeholder="New Password">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <input type="text" class="form-control form-control-rounded" id="input-1" name="password_confirmation" placeholder="Confirm New Password"
                                value="">
